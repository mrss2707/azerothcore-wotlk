...
class vip_item_commandscript : public CommandScript
{
public:
    vip_item_commandscript() : CommandScript("vip_item_commandscript") { }
...
void AddSC_vip_item_commandscript()
{
    new vip_item_commandscript();
}
*/
